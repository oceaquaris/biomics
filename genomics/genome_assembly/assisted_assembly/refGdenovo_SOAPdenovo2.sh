#!/bin/bash
#PBS -N refGSOAPdenovo2
#PBS -q mohamm20
#PBS -l nodes=1:ppn=20,walltime=336:00:00,naccesspolicy=singlejob
#PBS -l epilogue=/scratch/snyder/r/rshrote/epilogue.sh
################################################################################
# Reference-guided de novo assembly - SOAPdenovo2
#    by Heidi Lischer, 2015/2016 (See journal reference below)
#    modified by oceaquaris to include:
#       PBS job submission
#       bwa mem mapping
# ====================================================
# Journal Reference:
#    Lischer, H. E. L. & Shimizu, K. K. (2017). Reference-guided de novo
#    assembly approach improves genome reconstruction for related species.
#    BMC Bioinformatics, 18:474. DOI 10.1186/s12859-017-1911-6
################################################################################
...
# set the number of threads of every parallelizable step
